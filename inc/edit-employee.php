    ...
    <div class="card">
        ...
        <form>
            ...
            <div class="card-footer">
                <input class="form_data" type="hidden" name="emp_no" value="<?php echo $data['emp_no']; ?>">
                <input class="form_data" type="hidden" name="id" value="<?php echo $data['id']; ?>">
                <button class="form_data btn btn-success w-25" id="submit" type="submit" name="update" onclick="updateEmpData(); return false;">Update</button>
            </div>
        </form>
    </div>
</div>
